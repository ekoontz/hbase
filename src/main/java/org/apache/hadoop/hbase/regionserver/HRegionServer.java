...
public class HRegionServer implements HRegionInterface, HBaseRPCErrorHandler,
  ...
  public void abort(String reason, Throwable cause) {
    ...
    // HBASE-4014: show list of coprocessors that were loaded to help debug regionserver crashes.
    // Note that we're simply using java.util.HashSet's toString() method to print the coprocessor names.
